  ...
  module Actions
    class UpdateProjectCodesigningAction < Action
      def self.run(params)
        ...
        # other stuff from update_project_codesigning
        # now can be found and executed via https://docs.fastlane.tools/actions/automatic_code_signing/
        # Source: https://github.com/fastlane/fastlane/blob/master/fastlane/lib/fastlane/actions/automatic_code_signing.rb
